				...
				<div class="wrap_menu p-l-45 p-l-0-xl">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li>
								<a class="#page-scroll" href="{{url('/kategori')}}">Kategori</a>
							</li>
						</ul>
					</nav>
				</div>
...
<aside class="sidebar trans-0-4">
		...
		<ul class="menu-sidebar p-t-95 p-b-70">
			...
			<li class="t-center m-b-13">
				<!-- Button3 -->
				<a href="{{url('/')}}" class="btn3 flex-c-m size13 txt11 trans-0-4 m-l-r-auto">
					Sign up
				</a>
			</li>
			...
			<li class="t-center m-b-13">
				<a href="{{url('/kategori')}}" class="txt19">Kategori</a>
			</li> -->
